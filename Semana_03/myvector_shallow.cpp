...
// Constructor copia superficial
MyVector::MyVector(const MyVector &obj){
  std::cout << "Copy constructor invoked!" << std::endl;
  m_n = obj.m_n;
  data = obj.data; // Solamente se copia el puntero!!!
                   // Este comportamiento es MUY probablemente el que no deseamos
}
...
int main(){
  ...
  // Este código resulta en un error de memoria
  // Porqué? :o pensemos en que está haciendo el destructor en este punto
